...
window.CITY_DATA = [
  ...
  },
  {
    ...
    category: 'Atração',
    city: 'Canela',
    address: 'Rodovia RS-466, 3915 - Caracol, Canela - RS',
    hours: 'Segunda a sábado: 19:00h às 23:00h | Domingo: fechado',
  ...
  },
  {
    ...
    name: 'Antiga Estação Ferroviária de Canela',
    category: 'Cultura',
    city: 'Canela',
    address: 'Largo Benito Urbani - Centro, Canela - RS',
    hours: 'Conforme funcionamento do complexo',
    price: 'Gratuito para circulação nas áreas públicas',
    rating: '—',
    popularRank: 4,
    route: 4,
    image: 'imagens/estacao_campos_canella.png',
    summary: 'Antiga estação ferroviária revitalizada que atualmente abriga o complexo Estação Campos de Canella, com gastronomia, comércio e entretenimento.',
  ...
  },
  {
    ...
    category: 'Cultura',
    city: 'Canela',
    address: 'Praça Matriz, 69 - Centro, Canela - RS',
    hours: 'Diariamente: 08:00h às 19:00h',
    price: 'Gratuito',
  ...
  },
  {
    ...
    category: 'Evento',
    city: 'Canela',
    address: 'Diversos locais do centro de Canela - RS',
